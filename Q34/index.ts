...
//three favorite pizza 

let favorite_pizzas:string[]=['Meat Pizza','Veggie Pizza','Chicken BBQ Pizza'];

// using for loop to print name of each pizza

for(let favorite_pizza of favorite_pizzas){
    console.log(favorite_pizza)
};

// modify for loop to print a message for each favorite pizza
